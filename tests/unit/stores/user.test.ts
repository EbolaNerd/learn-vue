...
describe('actions', () => {
  ...
  describe('ADD_SELECTED_ORGANIZATIONS', () => {
    it('it updates the organizations the user has chosen to filter jobs by', () => {
      const store = useUserStore();
  ...
  describe('ADD_SELECTED_JOB_TYPES', () => {
    it('it updates the job types the user has chosen to filter jobs by', () => {
      const store = useUserStore();
